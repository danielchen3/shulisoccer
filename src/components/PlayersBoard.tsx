              ...
              <tbody>
                {data.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-1">{p.starts ?? "--"}</td>
                    <td className="px-2 py-1">{p.subs ?? "--"}</td>
                    <td className="px-2 py-1">{p.goals ?? "--"}</td>
                    <td className="px-2 py-1">{p.nationalityFlag ?? "--"}</td>
                  </tr>
                ))}
              </tbody>
            </table>
